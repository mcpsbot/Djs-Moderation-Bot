...
module.exports = {
  ...
  run: async (bot, message, args) => {
    if (
      !message.member.hasPermission("DEAFEN_MEMBERS") &&
      !ownerID.includes(message.author.id)
    ) {
      return message.channel.send(
        "**You Dont Have The Permissions To Ban Users! - [DEAFEN_MEMBERS]**"
      );
    }
    ...
    try {
      ...
      message.channel.send(
        "Oops! An unknow error occured. Please try again later."
      );
    }
  },
};
