        ...
        msg.channel
          ...
          .then((collected) => {
            switch (collected.first().content) {
              case "1":
                const check = db.fetch(`Welemtog_${message.guild.id}`);
                if (check === null) {
                  ...
                  return message.channel.send(
                    new MessageEmbed()
                      ...
                      .setColor("RANDOM")
                      .setDescription(
                        "I have successfully turned on the welcome embed system in this server"
                      )
                      .setFooter(
                  ...
                  message.channel.send(
                    "Welcome embed system is already turned on!!"
                  );
                }
                break;
              case "2":
                const vcheck = db.fetch(`Welemtog_${message.guild.id}`);
                if (vcheck === true) {
                  ...
                  return message.channel.send(
                    new MessageEmbed()
                      ...
                      .setColor("RANDOM")
                      .setDescription(
                        "I have successfully turned off the welcome embed system in the server"
                      )
                      .setTimestamp()
                  );
                } else {
                  message.channel.send(
                    "Please turn on the Welcome embed system first!!"
                  );
                }
                break;
              default:
      ...
      message.reply(wembed).then((msg) => {
        msg.channel
          ...
          .then((collected) => {
            switch (collected.first().content) {
              case "1":
                const check = db.fetch(`leavemtog_${message.guild.id}`);
                if (check === null) {
                  ...
                  return message.channel.send(
                    new MessageEmbed()
                      ...
                      .setColor("RANDOM")
                      .setDescription(
                        "I have successfully turned on the Leave embed system in this server"
                      )
                      .setFooter(
                        `Requested by ${message.author.username}`,
                        message.author.displayAvatarURL({
                  ...
                  message.channel.send(
                    "Leave embed system is already turned on!!"
                  );
                }
                break;
              case "2":
                const vcheck = db.fetch(`leavemtog_${message.guild.id}`);
                if (vcheck === true) {
                  ...
                  return message.channel.send(
                    new MessageEmbed()
                      ...
                      .setColor("RANDOM")
                      .setDescription(
                        "I have successfully turned off the Leave embed system in the server"
                      )
                      .setTimestamp()
                  );
                } else {
                  message.channel.send(
                    "Please turn on the Leave embed system first!!"
                  );
                }
                break;
              default:
